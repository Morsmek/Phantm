...
object PhantmCrypto {
    ...
    fun deriveTopic(publicKey: String): String {
    ...
    fun generateSalt(): String {
        ...
        return PhantmBase64.encode(bytes)
    }

    fun hashAppLockPin(pin: String, salt: String): String {
        val passwordBytes = pin.toByteArray(Charsets.UTF_8)
        val saltBytes = PhantmBase64.decode(salt)
        ...
        return PhantmBase64.encode(keyParam.key)
    }
